  ...
  return (
    <div className="flex bg-zinc-300">
          ...
          <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <div className=" flex justify-around col-span-full  items-center ">
                <button type="button" onClick={searchCategory} className="w-1/3 rounded-md dark:border-gray-700 bg-violet-900 p-2 text-zinc-50 text-lg hover:bg-violet-600 transition duration-500">
                  Buscar
                </button>
      ...
      <div className="modal flex flex-col w-full ">Lista</div>
        <ModalNewProduct isOpen={openModal} setOpenModal={()=>setOpenModal(!openModal)}/>
      </section>
